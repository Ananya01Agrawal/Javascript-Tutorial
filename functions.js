...
//in this we have talked about the functions,scope of variables: global variable and the local variable

if(1){
    let i =234;//here we have define the global variable
    console.log(i)
}
...
function ui(name)
{
    let i = 9;//here we have defined the local variable
    console.log(i);
